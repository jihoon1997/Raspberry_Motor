...
while True:
    ...
    if MaskFlag==1: #Mask Detection이 일어났을 때
        ...
        max_time=start_time+3.30 #max_time(동작시간)을 3.00초로 설정
        myPwm.ChangeDutyCycle(80) #Duty비 80%로 동작
        ...
        while True:
            ...
            if time.time()>max_time:
                ...
                myPwm.ChangeDutyCycle(42) #Duty비 40%로 동작
    ...
    if MaskFlag==2: #Mask Detection으로 차단 이후, 차단봉을 원래 위치로 위치시킬 때
        ...
        max_time2=start_time+3.30 #max_time(동작시간)을 3.00초로 설정
        myPwm.ChangeDutyCycle(80) #Duty비 80%로 동작
        ...
        while True:
            ...
            if time.time()>max_time2:
                ...
                myPwm.ChangeDutyCycle(40) #Duty비 40%로 동작
